...
type SubmitReceipt struct {
	...
	DataHash  []byte  `protobuf:"bytes,5,opt,name=dataHash" json:"dataHash,omitempty"`
}
...
func (x *SubmitReceipt) GetReason() string {
...
func (x *AcknowledgeMessagesRequest) GetMessageIDs() []string {
	if x != nil {
		return x.MessageIDs
	}
	return nil
...
func (x *AcknowledgeReceipt) GetMessageID() string {
	if x != nil && x.MessageID != nil {
		return *x.MessageID
	}
	return ""
...
func (x *AcknowledgeReceipt) GetOk() bool {
	if x != nil && x.Ok != nil {
		return *x.Ok
	}
	return false
...
func (x *AcknowledgeReceipt) GetReason() string {
	if x != nil && x.Reason != nil {
		return *x.Reason
	}
	return ""
...
type AcknowledgeMessagesResponse struct {
	...
	Receipts []*AcknowledgeReceipt `protobuf:"bytes,1,rep,name=receipts" json:"receipts,omitempty"`
}

func (x *AcknowledgeMessagesResponse) Reset() {
	*x = AcknowledgeMessagesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_message_queueing_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AcknowledgeMessagesResponse) Descriptor() ([]byte, []int) {
	return file_message_queueing_proto_rawDescGZIP(), []int{9}
}

func (x *AcknowledgeMessagesResponse) GetReceipts() []*AcknowledgeReceipt {
	if x != nil {
		return x.Receipts
	}
	return nil
...
func (x *WatchMessageRequest) Reset() {
	*x = WatchMessageRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_message_queueing_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *WatchMessageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WatchMessageRequest) ProtoMessage() {}

func (x *WatchMessageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_message_queueing_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WatchMessageRequest.ProtoReflect.Descriptor instead.
func (*WatchMessageRequest) Descriptor() ([]byte, []int) {
	return file_message_queueing_proto_rawDescGZIP(), []int{10}
}

type WatchMessageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *WatchMessageResponse) Reset() {
	*x = WatchMessageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_message_queueing_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *WatchMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WatchMessageResponse) ProtoMessage() {}

func (x *WatchMessageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_message_queueing_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WatchMessageResponse.ProtoReflect.Descriptor instead.
func (*WatchMessageResponse) Descriptor() ([]byte, []int) {
	return file_message_queueing_proto_rawDescGZIP(), []int{11}
}
...
var file_message_queueing_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xd3, 0x02, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x4d, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x12, 0x6d, 0x0a, 0x14, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x29, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	...
	,
}
...
var file_message_queueing_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_message_queueing_proto_goTypes = []interface{}{
	...
	(*AcknowledgeReceipt)(nil),          // 8: message_queueing.AcknowledgeReceipt
	(*AcknowledgeMessagesResponse)(nil), // 9: message_queueing.AcknowledgeMessagesResponse
	(*WatchMessageRequest)(nil),         // 10: message_queueing.WatchMessageRequest
	(*WatchMessageResponse)(nil),        // 11: message_queueing.WatchMessageResponse
	nil,                                 // 12: message_queueing.RawQueueMessage.AttributesEntry
	nil,                                 // 13: message_queueing.QueueMessage.AttributesEntry
}
var file_message_queueing_proto_depIdxs = []int32{
	12, // 0: message_queueing.RawQueueMessage.attributes:type_name -> message_queueing.RawQueueMessage.AttributesEntry
	13, // 1: message_queueing.QueueMessage.attributes:type_name -> message_queueing.QueueMessage.AttributesEntry
	...
	8,  // 5: message_queueing.AcknowledgeMessagesResponse.receipts:type_name -> message_queueing.AcknowledgeReceipt
	0,  // 6: message_queueing.QueueService.WriteMessages:input_type -> message_queueing.RawQueueMessage
	3,  // 7: message_queueing.QueueService.SubmitMessageBatch:input_type -> message_queueing.SubmitMessagesRequest
	5,  // 8: message_queueing.QueueService.RetrieveMessageBatch:input_type -> message_queueing.RetrieveMessagesRequest
	7,  // 9: message_queueing.QueueService.AcknowledgeMessageBatch:input_type -> message_queueing.AcknowledgeMessagesRequest
	2,  // 10: message_queueing.QueueService.WriteMessages:output_type -> message_queueing.SubmitReceipt
	4,  // 11: message_queueing.QueueService.SubmitMessageBatch:output_type -> message_queueing.SubmitMessagesResponse
	6,  // 12: message_queueing.QueueService.RetrieveMessageBatch:output_type -> message_queueing.RetrieveMessagesResponse
	9,  // 13: message_queueing.QueueService.AcknowledgeMessageBatch:output_type -> message_queueing.AcknowledgeMessagesResponse
...
func file_message_queueing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_queueing_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcknowledgeReceipt); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_queueing_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_message_queueing_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WatchMessageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_queueing_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WatchMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
